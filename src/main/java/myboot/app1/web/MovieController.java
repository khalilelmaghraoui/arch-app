...
public class MovieController {
	...
	@RequestMapping(value = "/movies/before/{year}")
	private ModelAndView getMoviesBefore2000(@PathVariable(value = "year", required = false) Integer year) {
		var res = new ModelAndView("moviesBefore2000");
		res.addObject("movies", dao.findAllBefore(year));
		return res;
	}
